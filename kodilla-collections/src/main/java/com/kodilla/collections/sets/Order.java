...
public class Order {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(getQuantity(), order.getQuantity()) == 0 && Objects.equals(getOrderNumber(), order.getOrderNumber()) && Objects.equals(getProductName(), order.getProductName());
    }
